...
window.PianoDiagnostics = (() => {
  const STORE_KEY = "piano_learning_error_log_6.2.7";
  const MAX = 60;
  ...
  function copyReport(){
    const text = JSON.stringify({app:"PIANO LEARNING",version:"6.2.7",generated:new Date().toISOString(),logs:load()},null,2);
